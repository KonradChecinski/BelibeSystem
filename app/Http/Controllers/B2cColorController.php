...
class B2cColorController extends Controller
{
    /**
    ...
    {
        return Inertia::render("Settings/Dictionaries/B2C/Color");
    }
...
//        dd($models->get()->toArray());
     ...
     */
    public function store(StoreB2cColorRequest $request)
    {
        B2cColor::create(["name" => $request->name]);
    }

    /**
     * Display the specified resource.
     */
    public function show(B2cColor $b2cColor)
    {
        //
    }
     ...
     */
    public function edit(B2cColor $b2cColor)
    {
        //
    }
     ...
     */
    public function update(UpdateB2cColorRequest $request, B2cColor $b2cColor)
    {
        $b2cColor->update(["name" => $request->name]);
    }

    /**
     * Remove the specified resource from storage.
     */
    public function destroy(DeleteB2cColorRequest $request, B2cColor $b2cColor)
    {
        $b2cColor->delete();
    }
}
