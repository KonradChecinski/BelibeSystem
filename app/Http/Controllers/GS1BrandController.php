...
class GS1BrandController extends Controller
{
    /**
    ...
    {
        return Inertia::render("Settings/Dictionaries/GS1/Brand");
    }
...
//        dd($models->get()->toArray());
     ...
     */
    public function store(StoreGS1BrandRequest $request)
    {
        GS1Brand::create(["name" => $request->name]);
    }

    /**
     * Display the specified resource.
     */
    public function show(GS1Brand $gS1Brand)
    {
        //
    }
     ...
     */
    public function edit(GS1Brand $gS1Brand)
    {
        //
    }
     ...
     */
    public function update(UpdateGS1BrandRequest $request, GS1Brand $GS1Brand)
    {
        $GS1Brand->update(["name" => $request->name]);
    }

    /**
     * Remove the specified resource from storage.
     */
    public function destroy(DeleteGS1BrandRequest $request, GS1Brand $GS1Brand)
    {
        $GS1Brand->delete();
    }
}
