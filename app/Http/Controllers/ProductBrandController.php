...
use App\Http\Requests\Product\DeleteProductBrandRequest;
...
class ProductBrandController extends Controller
{
    ...
    {
        return Inertia::render("Settings/Dictionaries/Brand");
    }
...
//        dd($models->get()->toArray());
    ...
    {
        $productBrand->update(["name" => $request->name]);
    }

    /**
     * Remove the specified resource from storage.
     */
    public function destroy(DeleteProductBrandRequest $request, ProductBrand $productBrand)
    {
        $productBrand->delete();
    }
}
