...
export default function CategoryModelsTable({models, readOnly, props}) {
                    ...
                    return (
                        <Box>
                            {props.auth.permissions.includes("editModel") ?
                                <Link href={route("system.products.model.edit", {id: row.original.id})}>
                                    <Button>Edytuj</Button>
                                </Link>
                                :
                                props.auth.permissions.includes("showModel") ?
                                    <Link href={route("system.products.model", {id: row.original.id})}>
                                        <Button>Pokaż</Button>
                                    </Link>
                                    : ""
                            }
