                                                    ...
                                                    <>
                                                        ...
                                                        <TableCell align={"center"}>
                                                            <Typography variant="body1" gutterBottom>
                                                                Kolor {item?.product_model_color?.shortcut}
                                                            </Typography>
                                                            <Typography variant="body1" gutterBottom>
                                                                {item?.product_model_color?.name}
                                                            </Typography>
                                                        </TableCell>
                                                        <TableCell align={"center"}>
                                                            <Typography variant="body1">
                                                    ...
                                                    (
                                                        <>
                                                            ...
                                                            <Typography variant="body1" color={"success.main"}>
                                                                {toLocaleString(item.discounted_price)}
                                                            </Typography>
                                                        </>
                                                    )}
                                                ...
                                                {item.price === item.discounted_price ?
                                                    ...
                                                    (
                                                        <>
                                                            ...
                                                            <Typography variant="body1" color={"success.main"}>
                                                                {toLocaleString(item.discounted_price * item.quantity)}
                                                            </Typography>
                                                        </>
                                                    )}
