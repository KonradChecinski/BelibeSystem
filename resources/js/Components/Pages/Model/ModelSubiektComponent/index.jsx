...
export default function ModelSubiektComponent({productModel, setProductModel, props}) {
    ...
    const saveB2C = () => {
        ...
        //     onSuccess: params => {
        //         setEdited(false);
        //         enqueueSnackbar("Zapisano Subiekt", {variant: 'success'})
        //     },
        //     onError: params => {
        //         enqueueSnackbar("Błąd przy zapisywaniu Subiekt", {variant: 'error'})
        //     },
        //     preserveScroll: true
        // })
    }
